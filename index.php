...
if ($_SERVER["REQUEST_METHOD"] == "POST" && empty($name_productErr) && empty($price_productErr)) {
    ...
    // sql create
    $sql = $con->prepare("INSERT INTO sistem_prncatatan_penjualan (name_product,price_product,created_at,updated_at) VALUES (?,?,?,?)");
...
//get data
$sql = "SELECT * FROM sistem_prncatatan_penjualan ORDER BY updated_at DESC";
