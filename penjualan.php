...
$get_product = $con->query("SELECT * FROM sistem_prncatatan_penjualan");
//get data
$sql = "SELECT * FROM tr_penjualan LEFT JOIN sistem_prncatatan_penjualan ON tr_penjualan.product_id = sistem_prncatatan_penjualan.id ORDER BY tr_penjualan.tgl_transaction DESC";
